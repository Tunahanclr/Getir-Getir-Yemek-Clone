...
export default function Hero() {
  ...
  return (
   <div>
     <div className='relative before:bg-gradient-to-r md:block hidden  before:from-brandColor before:to-transparent before:absolute  before:inset-0  before:h-[500px] before:z-10'>
        <Slider {...settings}>
      <div className=''>
